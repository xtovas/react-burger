...
const MenuNav = () => {
    ...
    return (
        <div className={IngredientStyles.tabs}>
            <Tab className={IngredientStyles.tabName} value="one" active={current === "one"} onClick={setCurrent}>
                Булки
            </Tab>
            <Tab className={IngredientStyles.tabName} value="two" active={current === "two"} onClick={setCurrent}>
                Соусы
            </Tab>
            <Tab className={IngredientStyles.tabName} value="three" active={current === "three"} onClick={setCurrent}>
                Начинки
            </Tab>
        </div>
    ) 
...
const TabsItem = (props) => {
    return (
        <div className={IngredientStyles.item}>
            ...
            <p className={IngredientStyles.item_title + "text text_type_main-default"}>{props.item.name}</p>
            <Counter className={IngredientStyles.counter} count={1} size="default"></Counter>
        </div>
    )
}
